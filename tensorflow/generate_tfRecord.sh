...
# ------------------------------------------------------ train
#python3 ./prepare_dataset/generate_tfrecord.py --csv_input=data/csv/uavsi_train_annotation.csv --output_path=data/record/uavsi_train_annotation.record

# ------------------------------------------------------- test
python3 ./prepare_dataset/generate_tfrecord.py --csv_input=data/csv/uavsi_test_annotation.csv --output_path=data/record/uavsi_test_annotation.record
#-------------------------------------------------------------
